 ...
 */
public class RentController implements Initializable, LanguageChangeListener {

    @FXML
    StackPane rent_root = new StackPane();
    ...
    public void setLable() {
        ...
        String str_price_label = I18N.convert("Price") + "/" + I18N.RentPriceUnit;
    ...
    public void areaList(){
        ...
        salable_area_low_popup = PopupHelper(salable_area_low_list, rent_root, salable_area_low_vbox);
        salable_area_high_popup = PopupHelper(salable_area_high_list, rent_root, salable_area_high_vbox);
        ...
        construction_area_low_popup = PopupHelper(construction_area_low_list, rent_root, construction_area_low_vbox);
        construction_area_high_popup = PopupHelper(construction_area_high_list, rent_root, construction_area_high_vbox);
    ...
    private ResultItem getResultInfo(HouseInfo house) {
        ...
        Double realPrice = (double) house.getRentPrice() / 100 * Double.valueOf(CurrentRate.getHKRate(I18N.country)) / I18N.RentPriceDivide;
        ...
        item.setPrice(price_label.getText(), String.valueOf(df.format(realPrice)) + " " + I18N.RentPriceUnit);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        district_popup = PopupHelper(district_list, rent_root, district_vbox);
        ...
        area_popup = PopupHelper(area_list, rent_root, area_vbox);
        ...
        type_popup = PopupHelper(type_list, rent_root, type_vbox);
        ...
        for (int i = 0; i < 10; i++) {
            price_low_content.add("" + (i * I18N.rgap + I18N.rbase) / I18N.RentPriceDivide);
        }
        price_low_list = ListViewHelper(price_low_content, price_low_hint, 161);

        List<String> price_high_content = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            price_high_content.add("" + (i * I18N.rgap + I18N.rbase) / I18N.RentPriceDivide);
        }
        price_high_list = ListViewHelper(price_high_content, price_high_hint, 161);

        price_low_popup = PopupHelper(price_low_list, rent_root, price_low_vbox);
        price_high_popup = PopupHelper(price_high_list, rent_root, price_high_vbox);
